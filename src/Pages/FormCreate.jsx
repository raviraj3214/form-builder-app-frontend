...
import FormmNav from "../components/FormNav";
import UserTookKit from "./formComponents/UserTookKit";
import { useNavigate, useParams } from "react-router-dom";
import { createForm, getFormById } from "../api/adminApis";
...
const FormCreate = () => {
  ...
  const handleSaveForm = async () => {
    ...
    if (formData.length < 2) {
      return toast.error("Form must contain at least one field!");
    }

    if (hasEmptyBubble) {
      return toast.error("All Bubble fields must have a value!");
    }
